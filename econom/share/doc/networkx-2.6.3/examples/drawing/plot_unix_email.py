...
to the receivers.  The edge data_ is a Python email.Message object which
contains all of the email message data_.

This example shows the power of `DiGraph` to hold edge data_ of arbitrary Python
